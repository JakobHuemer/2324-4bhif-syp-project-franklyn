...
* Passwortschutz bei `franklyn3` instructor client
* Exam Verwaltung
** create, getById, getAll, delete, start, complete, getExaminees, join
* Telemetry (Screenshots, ConnectionState)
** uploadAlphaFrame, uploadBetaFrame, heartbeat, downloadLatestFrame
* WIP: Video generierung
* Openbox
** Anpassung an neue backend API
** Alpha/Beta frames
** rewrite + dependency update

[.font-xx-large]
=== Implementierungsstatus
[cols="a,a"]
|===
| image::mt-new-status.png[]
| image::mt-old-status.png[]
|===
